...
public class CommonFunction_CCF extends TestBase{
	...
	public void MTAFlow(String code,String event) throws ErrorInTestMethod, Exception
	{
		...
		customAssert.assertTrue(funcPolicyDetails(common.MTA_excel_data_map, code, event), "Policy Details function having issue.");
		customAssert.assertTrue(common.funcMenuSelection("Navigate", "Previous Claims"), "Issue while Navigating to Previous Claims .");
...
public boolean funcPolicyDetails(Map<Object, Object> map_data,String code ,String event){
	...
	try{
		...
		if(common.currentRunningFlow.equals("NB") || (TestBase.businessEvent.equals("Rewind") && !(((String)common.Rewind_excel_data_map.get("Rewind_ExistingPolicy")).equalsIgnoreCase("Yes") && ((String)common.Rewind_excel_data_map.get("Rewind_ExistingPolicy_Type")).equalsIgnoreCase("Endorsement")))){
		...
		*/
		...
		double finalMDPremium = 0.00, finalBIPremium = 0.00;
		 ...
		 if(((String)outer_data_map.get("CD_MaterialDamage")).equalsIgnoreCase("Yes")){
			 ...
			 TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)outer_data_map.get("Automation Key"), "PS_MaterialDamage_NP", String.valueOf(finalMDPremium), outer_data_map);
			 ...
			 if(((String)outer_data_map.get("CD_BusinessInterruption")).equalsIgnoreCase("Yes")){
				 ...
				 TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)outer_data_map.get("Automation Key"), "PS_BusinessInterruption_NP", String.valueOf(finalBIPremium), outer_data_map);
			 }
		 }
			...
			try {	
				...
				case "RP":
					...
					if(!_cover.contains("BusinessInterruption")) {
						if(!(_cover.equals("MaterialDamage") && ((String)common.MTA_excel_data_map.get("CD_BusinessInterruption")).equalsIgnoreCase("Yes"))) {
							common.MTA_excel_data_map.put("PS_BusinessInterruption_NP", common_PEN.BI_Premium);
							TestUtil.reportStatus("Business Interruption Net Premium captured successfully . ", "Info", true);
						}
						return true;
					}
...
public boolean funcEmployersLiability(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
			  ...
			  common_PEN.EL_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("EmployersLiability")) {
	    		 		common.MTA_excel_data_map.put("PS_EmployersLiability_NP", common_PEN.EL_Premium);
	    		 		TestUtil.reportStatus("Employers Liability Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_EmployersLiability_NP", common_PEN.EL_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Employers Liability Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)data_map.get("Automation Key"), "PS_EmployersLiability_NP", String.valueOf(sPremiumm), data_map);
...
public boolean funcPublicLiability(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.PL_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("PublicLiability")) {
	    		 		common.MTA_excel_data_map.put("PS_PublicLiability_NP", common_PEN.PL_Premium);
	    		 		TestUtil.reportStatus("Public Liability Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_PublicLiability_NP", common_PEN.PL_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Public Liability Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_PublicLiability_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcProductsLiability(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.PRL_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("ProductsLiability")) {
	    		 		common.MTA_excel_data_map.put("PS_ProductsLiability_NP", common_PEN.PRL_Premium);
	    		 		TestUtil.reportStatus("Products Liability Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_ProductsLiability_NP", common_PEN.PRL_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Net Premium of Products Liability captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_ProductsLiability_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcSpecifiedAllRisks(Map<Object, Object> map_data){
	...
	try{
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_SpecifiedAllRisks_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcContractorsAllRisks(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.CAR_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("ContractorsAllRisks")) {
	    		 		common.MTA_excel_data_map.put("PS_ContractorsAllRisks_NP", common_PEN.CAR_Premium);
	    		 		TestUtil.reportStatus("Contractors All Risks Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_ContractorsAllRisks_NP", common_PEN.CAR_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Contractors All Risks Net Premium captured  . ", "Info", true);
	    			  return true;
...
//			String v_selectedTradeCode_Hazard = k.getLinkText("CCF_SearchedTradeCode");
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_ContractorsAllRisks_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcComputersandElectronicRisks(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.CER_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("ComputersandElectronicRisks")) {
	    		 		common.MTA_excel_data_map.put("PS_ComputersandElectronicRisks_NP", common_PEN.CER_Premium);
	    		 		TestUtil.reportStatus("Computers and Electronic Risks Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_ComputersandElectronicRisks_NP", common_PEN.CER_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Computers and Electronic Risks Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_ComputersandElectronicRisks_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcMoney(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.MONEY_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("Money")) {
	    		 		common.MTA_excel_data_map.put("PS_Money_NP", common_PEN.MONEY_Premium);
	    		 		TestUtil.reportStatus("Money Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_Money_NP", common_PEN.MONEY_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Money Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_Money_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcGoodsInTransit(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'gt2_tot')]")));
			  common_PEN.GIT_Premium = driver.findElement(By.xpath("//*[contains(@id,'gt2_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("GoodsInTransit")) {
	    		 		common.MTA_excel_data_map.put("PS_GoodsInTransit_NP", common_PEN.GIT_Premium);
	    		 		TestUtil.reportStatus("Goods In Transit Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_GoodsInTransit_NP", common_PEN.GIT_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Goods In Transit Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_GoodsInTransit_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcMarineCargo(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.MC_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("MarineCargo")) {
	    		 		common.MTA_excel_data_map.put("PS_MarineCargo_NP", common_PEN.MC_Premium);
	    		 		TestUtil.reportStatus("Marine Cargo Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_MarineCargo_NP", common_PEN.MC_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Marine Cargo Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_MarineCargo_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcCyberAndDataSecurity(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.CDS_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("CyberandDataSecurity")) {
	    		 		common.MTA_excel_data_map.put("PS_CyberandDataSecurity_NP", common_PEN.CDS_Premium);
	    		 		TestUtil.reportStatus("Cyber and Data Security Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_CyberandDataSecurity_NP", common_PEN.CDS_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Cyber and Data Security Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_CyberandDataSecurity_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcDirectorsAndOfficers(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.DnO_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("DirectorsandOfficers")) {
	    		 		common.MTA_excel_data_map.put("PS_DirectorsandOfficers_NP", common_PEN.DnO_Premium);
	    		 		TestUtil.reportStatus("Directors and Officers Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_DirectorsandOfficers_NP", common_PEN.DnO_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Directors and Officers Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_DirectorsandOfficers_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcFrozenFoods(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.FF_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("FrozenFoods")) {
	    		 		common.MTA_excel_data_map.put("PS_FrozenFoods_NP", common_PEN.FF_Premium);
	    		 		TestUtil.reportStatus("Frozen Foods Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_FrozenFoods_NP", common_PEN.FF_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Frozen Foods Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_FrozenFoods_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcLossofLicence(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.LOL_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("LossofLicence")) {
	    		 		common.MTA_excel_data_map.put("PS_LossOfLicence_NP", common_PEN.LOL_Premium);
	    		 		TestUtil.reportStatus("Loss of Licence Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_LossOfLicence_NP", common_PEN.LOL_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Loss of Licence Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_LossOfLicence_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcFidelityGuarantee(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.FG_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("FidelityGuarantee")) {
	    		 		common.MTA_excel_data_map.put("PS_FidelityGuarantee_NP", common_PEN.FG_Premium);
	    		 		TestUtil.reportStatus("Fidelity Guarantee Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_FidelityGuarantee_NP", common_PEN.FG_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Fidelity Guarantee Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+common.currentRunningFlow, "Premium Summary",(String)map_data.get("Automation Key"), "PS_FidelityGuarantee_NP", String.valueOf(sPremiumm), map_data);
...
public boolean funcTerrorism(Map<Object, Object> map_data){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
	    	  ...
	    	  JavascriptExecutor j_exe = (JavascriptExecutor) driver;
			  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@id,'_tot')]")));
			  common_PEN.TER_Premium = driver.findElement(By.xpath("//*[contains(@id,'_tot')]")).getAttribute("value");
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("Terrorism")) {
	    		 		common.MTA_excel_data_map.put("PS_Terrorism_NP", common_PEN.TER_Premium);
	    		 		TestUtil.reportStatus("Terrorism Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_Terrorism_NP", common_PEN.TER_Premium);
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Terrorism Net Premium captured  . ", "Info", true);
	    			  return true;
...
public boolean funcLegalExpenses(Map<Object, Object> map_data,String code,String event){
	...
	try{
		...
		if(!common.currentRunningFlow.equalsIgnoreCase("NB")){
			  ...
			  try{
				  k.ImplicitWaitOff();
				  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@name,'_pcc_premium')]")));
				  common_PEN.LE_Premium = driver.findElement(By.xpath("//*[contains(@name,'_pcc_premium')]")).getAttribute("value");
				  k.ImplicitWaitOn();
			  }catch(Exception e){
				  k.ImplicitWaitOff();
				  j_exe.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//*[contains(@name,'_pen_premium')]")));
				  common_PEN.LE_Premium = driver.findElement(By.xpath("//*[contains(@name,'_pen_premium')]")).getAttribute("value");
				  k.ImplicitWaitOn();
			  }
	    	  ...
	    	  try {	  
	    		  ...
	    		  case "RP":
	    		 	...
	    		 	if(!_cover.contains("LegalExpenses")) {
	    		 		common.MTA_excel_data_map.put("PS_LegalExpenses_NP", common_PEN.LE_Premium.replaceAll(",", ""));
	    		 		TestUtil.reportStatus("Legal Expenses Net Premium captured successfully . ", "Info", true);
	    		 		return true;
	    		 	}
	    		 	break;
	    		  ...
	    		  case "Non-Financial":
	    			  ...
	    			  common.MTA_excel_data_map.put("PS_LegalExpenses_NP", common_PEN.LE_Premium.replaceAll(",", ""));
	    			  TestUtil.reportStatus("Due to Non-Financial Flow, Only Legal Expenses Net Premium captured  . ", "Info", true);
	    			  return true;
		...
		customAssert.assertTrue(k.Input("CCF_LE_Wages", (String)map_data.get("LE_Wages")),"Unable to enter value in Wages  . ");
				...
				String AP_RP_Flag = "";
				String s_CoverName = "LegalExpenses";
				String coverPremium = common_PEN.LE_Premium;
				...
				if(!AP_RP_Flag.equals("") && Double.parseDouble(coverPremium) != 0.0){
					double le_netP = get_LE_NetP(AP_RP_Flag,s_CoverName);
					map_data.put("LE_NetPremium", Double.toString(le_netP));
					customAssert.assertTrue(k.Input("CCF_LE_NetPremium", (String)map_data.get("LE_NetPremium")),"Unable to enter value in NetPremium  . ");
				}else {
					try{
						k.ImplicitWaitOff();
						if(k.isDisplayedWithoutError("CCF_LE_NetPremium")){
							k.InputWithoutError("CCF_LE_NetPremium", (String)map_data.get("LE_NetPremium"));
							...
							k.InputWithoutError("CCK_LE_NetPremium", (String)map_data.get("LE_NetPremium"));
							int LE_Premium_Decimal_Places = common.countDecimalPlaces(k.getAttribute("CCK_LE_NetPremium", "value"));
							boolean decimalFlag = LE_Premium_Decimal_Places > 2 ?false:true;
							customAssert.assertTrue(decimalFlag , "LE Premium Should contain up to two Decimal Places . ");
						}
						k.ImplicitWaitOn();
		...
		*/
		...
		WriteDataToXl(code+"_"+event, "Legal Expenses", testName, "LE_AnnualCarrierPremium", exp_AnnualCarrierPremium,map_data);
		WriteDataToXl(code+"_"+event, "Premium Summary", testName, "PS_LegalExpenses_NP", (String)map_data.get("LE_NetPremium"),map_data);
...
* 
*/
public static double get_LE_NetP(String MTA_Operation,String Cover){
	...
	switch(Cover.replaceAll(" ", "")) {
		case "LegalExpenses":
			coverPremium = common_PEN.LE_Premium;
			break;
	}
		...
		try{
			...
			switch(MTA_Operation){
				case "AP":
					le_netP = Double.parseDouble(coverPremium) * 2; 
				break;
				case "RP":
					le_netP = Double.parseDouble(coverPremium) - ((Double.parseDouble(coverPremium)*90)/100);
				break;
				case "":
				break;
				default:
			...
			System.out.println("Error while getting book Rate - "+t.getLocalizedMessage());
		}
...
* 
*/
public static double get_MD_BI_DeclaredValue(String MTA_Operation,String Cover){
	...
	switch(Cover.replaceAll(" ", "")) {
		...
		case "BusinessInterruption":
			coverPremium = common_PEN.BI_Premium;
			break;
	}
		...
		try{
			...
			switch(MTA_Operation){
				case "AP":
					mdBi_DV = Double.parseDouble(coverPremium) * 2; 
				break;
				case "RP":
					mdBi_DV = Double.parseDouble(coverPremium) - ((Double.parseDouble(coverPremium)*90)/100);
				break;
				case "":
				break;
				default:
			...
			System.out.println("Error while getting DV - "+t.getLocalizedMessage());
		}
...
//----------------------------------------------------------------//
			...
			for(String cover : covers){	
				...
				case "MaterialDamage":
					if(((String)data_map.get("CD_MaterialDamage")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Insured Properties"),"Issue while Navigating to Insured Properties  . ");
						customAssert.assertTrue(funcInsuredProperties(data_map,internal_data_map), "Insured Property function is having issue(S) . ");
					}	
				break;
				case "BusinessInterruption":
				...
				case "Liability":
					if(((String)data_map.get("CD_Liability")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Employers Liability"),"Issue while Navigating to Employers Liability  . ");
						customAssert.assertTrue(funcEmployersLiability(data_map), "Employers Liability function is having issue(S) . ");
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Public Liability"),"Issue while Navigating to Public Liability  . ");
						customAssert.assertTrue(funcPublicLiability(data_map), "Public Liability function is having issue(S) . ");
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Products Liability"),"Issue while Navigating to Products Liability  . ");
						customAssert.assertTrue(funcProductsLiability(data_map), "Products Liability function is having issue(S) . ");
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Liability Information"),"Issue while Navigating to Liability Information  . ");
				...
				case "ContractorsAllRisks":
					if(((String)data_map.get("CD_ContractorsAllRisks")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Contractors All Risks"),"Issue while Navigating to Specified All Risks  . ");
						customAssert.assertTrue(funcContractorsAllRisks(data_map), "Contractors All Risks function is having issue(S) . ");
						}
				break;
				case "ComputersandElectronicRisks":
					if(((String)data_map.get("CD_ComputersandElectronicRisks")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Computers and Electronic Risks"),"Issue while Navigating to Computers and Electronic Risks  . ");
						customAssert.assertTrue(funcComputersandElectronicRisks(data_map), "Computers and Electronic Risks function is having issue(S) . ");
						}
				break;
				case "Money":
					if(((String)data_map.get("CD_Money")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Money"),"Issue while Navigating to Money screen . ");
						customAssert.assertTrue(funcMoney(data_map), "Money function is having issue(S) . ");
						}
				break;
				case "GoodsInTransit":
					if(((String)data_map.get("CD_GoodsInTransit")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Goods In Transit"),"Issue while Navigating to Goods In Transit screen . ");
						customAssert.assertTrue(funcGoodsInTransit(data_map), "Goods In Transit function is having issue(S) . ");
						}
				break;
				case "MarineCargo":
				if(((String)data_map.get("CD_MarineCargo")).equals("Yes")){		
					customAssert.assertTrue(common.funcMenuSelection("Navigate","Marine Cargo"),"Issue while Navigating to Marine Cargo screen . ");
					customAssert.assertTrue(funcMarineCargo(data_map), "Marine Cargo function is having issue(S) . ");
					}
				break;
				case "CyberandDataSecurity":
					if(((String)data_map.get("CD_CyberandDataSecurity")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Cyber and Data Security"),"Issue while Navigating to Cyber and Data Security screen . ");
						customAssert.assertTrue(funcCyberAndDataSecurity(data_map), "Cyber and Data Security function is having issue(S) . ");
						}
				break;
				...
				break;
				case "FrozenFood":
					if(((String)data_map.get("CD_FrozenFood")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Frozen Foods"),"Issue while Navigating to Frozen Foods screen . ");
						customAssert.assertTrue(funcFrozenFoods(data_map), "Frozen Foods function is having issue(S) . ");
						}
				break;
				case "LossofLicence":
					if(((String)data_map.get("CD_LossofLicence")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Loss of Licence"),"Issue while Navigating to Loss of Licence screen . ");
						customAssert.assertTrue(funcLossofLicence(data_map), "Loss of Licence function is having issue(S) . ");
						}
				break;
				case "FidelityGuarantee":
					if(((String)data_map.get("CD_FidelityGuarantee")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Fidelity Guarantee"),"Issue while Navigating to Fidelity Guarantee screen . ");
						customAssert.assertTrue(funcFidelityGuarantee(data_map), "Fidelity Guarantee function is having issue(S) . ");
						}
				break;
				case "Terrorism":
					if(((String)data_map.get("CD_Terrorism")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Terrorism"),"Issue while Navigating to Terrorism screen . ");
						customAssert.assertTrue(funcTerrorism(data_map), "Terrorism function is having issue(S) . ");
						}
				break;
				case "LegalExpenses":
					if(((String)data_map.get("CD_LegalExpenses")).equals("Yes")){		
						customAssert.assertTrue(common.funcMenuSelection("Navigate","Legal Expenses"),"Issue while Navigating to Legal Expenses screen . ");
						customAssert.assertTrue(funcLegalExpenses(data_map,"",""), "Legal Expenses function is having issue(S) . ");
						}
				break;
				default:
	...
	public boolean Cover_selection_linear(Map<Object,Object> data_map){
		...
		try{
			...
			if(((String)data_map.get("CD_MaterialDamage")).equals("Yes")){		
				customAssert.assertTrue(common.funcMenuSelection("Navigate","Insured Properties"),"Issue while Navigating to Insured Properties  . ");
				customAssert.assertTrue(funcInsuredProperties(data_map,common.NB_Structure_of_InnerPagesMaps), "Insured Property function is having issue(S) . ");
			}
