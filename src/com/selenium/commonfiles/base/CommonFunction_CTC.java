...
public class CommonFunction_CTC extends TestBase{
...
public void NewBusinessFlow(String code,String event) throws ErrorInTestMethod{
	...
	try{
		...
		customAssert.assertTrue(common_CCK.funcPolicyDetails(common.NB_excel_data_map,code,event), "Policy Details function having issue .");
...
public void RenewalFlow(String code,String event) throws Throwable{
	...
	try{
		...
		customAssert.assertTrue(common_CCK.funcPolicyDetails(common.Renewal_excel_data_map,code,event), "Policy Details function having issue .");
		customAssert.assertTrue(common.funcMenuSelection("Navigate","Previous Claims"),"Issue while Navigating to Previous Claims  . ");
...
//			}
	...
	public void RewindFlow(String code,String event) throws ErrorInTestMethod{
		...
		try{
			...
			/*if(TestBase.businessEvent.equalsIgnoreCase("Renewal") ){*/
				customAssert.assertTrue(common_CCK.funcPolicyDetails(common.Rewind_excel_data_map,code,event), "Policy Details function having issue .");
			/*}else{
