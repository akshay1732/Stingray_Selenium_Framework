...
public boolean Cargo(Map<Object, Object> map_data)
{
	...
	try
	{
		...
		if(TestBase.businessEvent.equalsIgnoreCase("MTA") && ((String)common.MTA_excel_data_map.get("MTA_ExistingPolicy")).equalsIgnoreCase("Yes"))
		{
			...
			{
				case "AP":
						aprp_PremiumOverride = common_EP.doUniCoverAP("//*[@id='table0'][2]/tbody/tr", 8, 9);
						break;
						
				case "RP":
						aprp_PremiumOverride = common_EP.doUniCoverRP("//*[@id='table0'][2]/tbody/tr", 8 ,9);
						break;
						
				case "Non-Financial":
							TestUtil.reportStatus("Due to Non-Financial Flow, Cargo Cover's Net Net Premium will be captured.", "Info", true);
							break;
			}
		}
