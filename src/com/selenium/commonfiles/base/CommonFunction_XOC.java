...
public class CommonFunction_XOC extends TestBase
{
	...
	public void MTAFlow(String code,String fileName) throws ErrorInTestMethod
	{
		...
		try
		{
			...
			{
				customAssert.assertTrue(common_EP.ExistingPolicyAlgorithm_VELA(common.MTA_excel_data_map , (String)common.MTA_excel_data_map.get("MTA_ExistingPolicy_Type"), (String)common.MTA_excel_data_map.get("MTA_ExistingPolicy_Status")), "Existing Policy Algorithm function is having issues. ");
			}
			else 
			{
	...
	public boolean MaterialFactsDeclerationPage()
	{
		...
		try
		{
			...
			for(int i = 0;i<elements.size();i++)
			{
			 ...
			 {
				String[] MDF_Limits = ((String)data_map.get("xoc_products_liability")).split(",");
